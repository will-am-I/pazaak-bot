...
class Help(commands.Cog):
   ...
   async def help (self, ctx, command=None, dmcommand=None):
      if command is None:
         embed = discord.Embed(title="How to play pazaak", colour=discord.Colour(0x4e7e8a), description="Type p.help <command> for more information about each one or p.help sidedeck for help in side deck selection.")
